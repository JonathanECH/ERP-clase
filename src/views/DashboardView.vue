...
<template>
  <div>
    ...
    <v-row>
      <v-col cols="12" md="3">
        <TarjetaKPI titulo="Ventas del mes" :valor="'$' + ventasDelMes.toLocaleString()" icono="mdi-cash-plus"
          color="primary" />
      </v-col>
      <v-col cols="12" md="3">
        <TarjetaKPI titulo="Gastos del mes" :valor="'$' + gastosDelMes.toLocaleString()" icono="mdi-cash-minus"
          color="secondary" />
      </v-col>
      <v-col cols="12" md="3">
