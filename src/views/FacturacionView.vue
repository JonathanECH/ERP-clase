      ...
      <v-col cols="12" md="7">
        <v-card>
          ...
          <v-card-text>
            <v-row>
              <v-col cols="12" md="6">
                <v-select v-model="clienteSeleccionado" :items="clientesDisponibles" label="Cliente" variant="outlined"
            ...
            <v-card v-for="(linea, idx) in detalle" :key="idx" variant="outlined" class="mb-2 pa-2">
              <v-row align="center">
                <v-col cols="12" md="5">
                  <v-text-field v-model="linea.concepto" label="Concepto" variant="outlined" density="compact"
                    hide-details />
                </v-col>
                <v-col cols="4" md="2">
                  <v-text-field v-model.number="linea.cantidad" label="Cant." type="number" variant="outlined"
                    density="compact" hide-details />
                </v-col>
                <v-col cols="4" md="2">
                  <v-text-field v-model.number="linea.precioUnitario" label="P. Unit." type="number" variant="outlined"
                    density="compact" hide-details prefix="$" />
                </v-col>
                <v-col cols="3" md="2">
                ...
                <v-col cols="1">
                  <v-btn icon="mdi-delete" size="small" color="error" variant="text" @click="eliminarLinea(idx)"
