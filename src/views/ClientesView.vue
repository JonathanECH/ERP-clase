...
const clientes = ref([
  { id: 1, nombre: 'Distribuidora del Norte S.A.', rfc: 'DNO900101ABC', email: 'ventas@norte.mx', telefono: '023237623', tipo: 'proveedor', saldo: 600 },
  { id: 2, nombre: 'Papelería Central', rfc: 'PCE850515XYZ', email: 'contacto@central.mx', telefono: '023263645', tipo: 'cliente', saldo: 1200 },
  { id: 3, nombre: 'Servicios Técnicos López', rfc: 'STL920320DEF', email: 'lopez@servicios.mx', telefono: '023266774', tipo: 'cliente', saldo: 239 }
])
const busqueda = ref('')
      ...
      <v-card>
        ...
        <v-card-text>
          <v-form>
            ...
            <v-select v-model="formulario.tipo" :items="['cliente', 'proveedor']" label="Tipo" variant="outlined"
              class="mb-2" />
            <v-text-field v-model.number="formulario.saldo" label="Saldo inicial" type="number" variant="outlined"
              prefix="$" />
          </v-form>
        </v-card-text>
        <v-card-actions>
